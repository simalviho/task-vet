...
type BannerProps = object;

const Banner: React.FC<BannerProps> = ({}) => {
  return (
    <div className="bg-[#2b74dd] relative flex w-full xl:px-[137px] md:px-8 px-4">
      <svg
        version="1.1"
        id="Layer_1"
        ...
        y="0px"
        viewBox="0 0 960 280"
        enableBackground="new 0 0 960 280"
        xmlSpace="preserve"
      >
        <g>
          <path
            fill="#FFFFFF"
            d="M864.564,85.258c0.021,2.694,0.185,5.355,0.485,7.975c1.731,15.145-6.251,29.783-20.103,36.144
    ...
    C897.31,10.572,864.243,44.4,864.564,85.258z"
          ...
          <path
            fill="#FFFFFF"
            d="M500.675,280c4.827-9.3,12.058-17.613,21.014-23.97c-13.692-14.565-34.44-24.03-57.666-24.03
    ...
    H500.675z"
          ...
          <path
            fill="#FFFFFF"
            d="M500.675,280h35.204c-2.835-8.827-7.714-16.903-14.19-23.793C512.732,262.563,505.502,270.7,500.675,280z"
          />
        </g>
        <path
          opacity="0.63"
          fill="#FFFFFF"
          d="M229.901,157.397c10.583,23.588,10.583,23.588,23.404,25.635c0,0,0.766,0.123,0.77,0.123
    ...
    c9.352,0.873,26.957-53.517,63.084-36.522"
        ...
        <path
          opacity="0.63"
          fill="#FFFFFF"
          d="M688.855,180.271c0.104-0.026,0.207-0.052,0.313-0.078
    ...
    C629.596,217.477,653.208,189.309,688.855,180.271z"
      ...
      <div className="relative z-90 grid lg:grid-cols-[520px_1fr] grid-cols-1 lg:pb-0 lg:pt-0  pt-20 pb-40 w-full gap-4">
        <div className="relative aspect-[520/415] lg:w-[520px] mx-auto w-full lg:max-w-full max-w-[420px]">
          <Image src={pet} alt="404 page image" fill objectFit="contain" />
        </div>
        <div className="flex flex-col lg:items-start items-center justify-center lg:gap-y-8 gap-y-4">
          <h1 className="text-white lg:text-left text-center lg:leading-12 lg:text-[40px] text-3xl font-semibold">
            En Gelişmiş Veteriner Klinik Programı
          </h1>
          <p className="text-xl lg:text-left text-center text-white">
            Kliniğiniz için kolay, gelişmiş ve güçlü bir veteriner yazılımı
          </p>
          <button className="px-8 py-2 text-lg whitespace-nowrap bg-white rounded-full text-lg text-[#2b74dd]">
